...
// Compiles with AFL's afl-cc and links against libpng + zlib.
...
/**
 * @brief Cleans up all resources allocated during the PNG read process.
 * * This is crucial for fuzzing to prevent memory leaks and ensure stable execution.
 */
...
int main(int argc, char **argv) {
    ...
    // --- File Opening and Signature Check ---
    ...
    // --- libpng Structure Initialization ---
    ...
    // --- Transformations for Code Coverage (Testing 'set' APIs) ---
    // Exercise various conversion paths based on input type:
    ...
    // --- Optional Ancillary Data Reading (Testing 'get' APIs) ---
